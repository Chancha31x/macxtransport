...
function calculateTruckPriceDetails(truckType, distanceKm) {
    ...
    switch (truckType) {
        ...
        case "รถ 4 ล้อจัมโบ้":
            ...
            pricePerKmRanges = [
                { max: 100, rate: 24, serviceCharge: 700 },
                { max: 200, rate: 23, serviceCharge: 500 },
                { max: 300, rate: 22, serviceCharge: 500 },
                { max: 400, rate: 20, serviceCharge: 500 },
                { max: 500, rate: 18, serviceCharge: 500 },
                { max: 600, rate: 17, serviceCharge: 500 },
                { max: 700, rate: 15, serviceCharge: 500 },
                { max: 800, rate: 14, serviceCharge: 500 },
                { max: 900, rate: 13, serviceCharge: 500 },
        ...
        case "รถบรรทุก 6 ล้อ":
            ...
            pricePerKmRanges = [
                ...
                { max: 200, rate: 24, serviceCharge: 600 },
                { max: 300, rate: 23, serviceCharge: 600 },
                { max: 400, rate: 22, serviceCharge: 600 },
                { max: 500, rate: 20, serviceCharge: 600 },
                { max: 600, rate: 19, serviceCharge: 600 },,
                { max: 700, rate: 17, serviceCharge: 600 },
                { max: 800, rate: 17, serviceCharge: 600 },
                { max: 900, rate: 17, serviceCharge: 600 },
